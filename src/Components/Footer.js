...
const Footer = () => {
  return (
    ...
    <div className=" bg-red-500 h-full flex flex-col gap-8 items-center justify-between p-10 sm:p-7">
      <h2 
      data-aos="zoom-out"
      ...
      <div className="sm:text-[12px]">
        | Copyright &copy; <span>2023 Madanraj </span> All rights reserved
        <a href="#"></a> |
      </div>
    </div>
  </div>
